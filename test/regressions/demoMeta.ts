...
export const SLUG_A11Y = new Map<string, SlugA11y>([
  ...
  ['bottom-navigation', { component: 'BottomNavigation', skipAssertions: PARTIAL_CONTRAST }],
  ...
  ['floating-action-button', { component: 'Fab', skipAssertions: PARTIAL_CONTRAST }],
  ...
  ['skeleton', { component: 'Skeleton', skipAssertions: PARTIAL_CONTRAST }],
