...
describe('<Tooltip />', () => {
  ...
  describe('prop: placement', () => {
    it('should have top placement', () => {
      ...
      render(
        <Tooltip title="Hello World" slots={{ popper: PopperSpy }} placement="top">
          <button id="testChild" type="submit">
            Hello World
          </button>
        </Tooltip>,
    ...
    it('should use hysteresis with the enterDelay', () => {
      render(
        <Tooltip
          ...
          enterNextDelay={30}
          leaveDelay={5}
          slotProps={{ transition: { timeout: 6 } }}
        >
          <button id="testChild" type="submit">
            Hello World
          </button>
  ...
  describe('prop: slotProps.popper', () => {
    it('should pass slotProps.popper to Popper Component', () => {
      render(
    ...
    it('should allow className from slotProps.popper', () => {
      render(
        <Tooltip
          title="Hello World"
          open
          slotProps={{ popper: { 'data-testid': 'popper', className: 'my-class' } }}
        >
          <button type="submit">Hello World</button>
        </Tooltip>,
      );
