...
describe('<LinearProgress />', () => {
  ...
  it('should set width of bar1 and bar2 on buffer variant', () => {
    ...
    expect(progressbar.children[1]).to.have.nested.property('style.transform', 'translateX(-23%)');
    expect(progressbar.children[2]).to.have.nested.property('style.transform', 'translateX(-15%)');
  });
